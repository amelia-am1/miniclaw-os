...
export class GeminiClient {
  ...
  /** Generate an image using multiple reference images + a prompt. */
  async genFromRefs(imagePaths: string[], prompt: string, seed?: number, aspectRatio?: string): Promise<GenerateResult> {
    const t0 = Date.now();
